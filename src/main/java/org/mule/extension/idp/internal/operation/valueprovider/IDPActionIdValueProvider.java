...
public class IDPActionIdValueProvider implements ValueProvider {
    ...
    public Set<Value> resolve() throws ValueResolvingException {
        ...
        try {
            new IDPPlatformOperations().listActions(connection, new IDPPageable(0,100, IDPSortOption.UPDATED_AT_DESC), createCallbackHandler(countDownLatch, valuesReference, throwableReference, EXPRESSION));
